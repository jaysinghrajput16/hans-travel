...
export default function Footer({ onOpenManageBooking }) {
  ...
  return (
    <footer id="footer" className="bg-gray-950 text-white pt-12 pb-8 border-t border-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 pb-8 border-b border-gray-900">
          ...
          <div className="space-y-3">
            ...
            <p className="text-xs text-gray-400 leading-relaxed">
              Hans Travels I Pvt Ltd. — Leading commercial passenger transportation since the 1980s. Operating 150+ buses across 50+ routes &amp; 70+ cities. Bon voyage. Home on wheels.
            </p>
          </div>
          ...
          <div className="space-y-2.5">
            ...
            <ul className="space-y-2 text-xs text-gray-400">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:support@hanstravels.com" className="hover:text-white transition-colors font-medium">
              ...
              <li>
                <button
                  type="button"
                  id="Contact Support"
                  className="Contact Support contact-support text-red-400 hover:text-red-300 font-semibold transition-colors cursor-pointer flex items-center gap-1.5 pt-1"
                >
                  <MessageSquare className="w-3.5 h-3.5" />
                  <span>Contact Support (Live Chat)</span>
                </button>
              </li>
              <li className="text-[11px] text-gray-500 pt-0.5">
